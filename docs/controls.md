...
| Ctrl+; | Auto-walk to the reviewed target. A blocked object's center can use a fully reachable, safe standing point within 3.5 units instead. Stops at that approach; J interacts or attacks. Walls are never broken automatically. |
